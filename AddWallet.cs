...
namespace CourseWork
{
    public partial class AddWallet : Form
    {
        ...
        private void AddWall_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "SELECT 1 FROM WALLETS WHERE Name = @WalletName";
                ...
                begSumm *= _koef;
                SqlCommand command = new SqlCommand("INSERT INTO [Wallets] (Name, Description, Value) VALUES (@Name, @Description, @Value)", connectCourseDB);
